        ...
        <div class="inner-container"><a href="/<?php echo $locale ?>/" class="header__logo">
          ...
          <nav>
            <ul>
              ...
              <li><a href="/<?php echo $locale ?>/contest-details.html">比賽詳情</a></li>
              <li><a href="/user/entry/entry?lang=<?php echo $locale ?>">參賽作品</a></li>
              <li><a href="/<?php echo $locale ?>/judges.html">JUDGES</a></li>
              <li><a href="/<?php echo $locale ?>/exhibitions.html">展覽</a></li>
              <li><a href="/<?php echo $locale ?>/gallery/" class="last">優勝者畫廊</a></li>
            </ul>
          </nav>
        </div>
      </header>