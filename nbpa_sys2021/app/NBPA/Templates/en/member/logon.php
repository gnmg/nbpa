...
<div class="sys-body">
    ...
    <div id="container">
        <div id="content">
            ...
            <p style="color:red;">We had some system problems over the last few day that have been fixed but there are still some affected accounts.</br></br>If you are not able to login to your account or recover a forgotten password then please contact us at the following address.</br></br><a href='mailto: support@naturesbestphotography.asia'>support@naturesbestphotography.asia</a></p>
            <div id="regist_form">
