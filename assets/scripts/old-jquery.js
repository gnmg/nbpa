...
! function(a, b) {
  ...
  function m(a) {
    ...
    function j(a, c) {
      ...
      if (c.handler && f[c.handler]) e = f[c.handler](a, instance, l), d = c.handler;
      else {
        var g = {};
  ...
  var n = a.document,
    ...
    p = b("html"),
    q = 0,
    r = /\.(png|jpg|jpeg|gif|tiff|bmp)(\?\S*)?$/i,
  ...
  return m.version = "1.4.2", m.handlers = b.proxy(e, m, v), m.options = b.proxy(e, m, w), b(n).on("click", "[data-lity]", m()), m
});*/