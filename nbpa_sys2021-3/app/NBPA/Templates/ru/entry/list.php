        ...
        <div id="content">
            ...
            <div id="regist_form">
                ...
                <form id="frm_entry" method="post" action="/user/entry/list/<?php echo h($category); ?>">
                    ...
                    <h3 class="mainTi"><label>Категория:</label>
                    ...
                    <table class="input_table">
                        ...
                        <tr>
                            <th colspan="2">
                                ...
                                Удалить фотографию</th>
                        </tr>
                        <?php endif; ?>
                        <?php if ($item->judge_status == 4): ?>
                        <tr>
                            <th colspan="2">
                                <a href="/user/entry/hires/<?php echo h($item->regist_apply_no); ?>">Пропускать</a>
                            </th>
                        </tr>
                        <?php endif; ?>
                        <?php endforeach; ?>
                    ...
                    <ul class="submitList">
                        ...
                        <?php if ($inTerm): ?>
                        <li><input type="submit" name="drop" value="Удалить" class="submitBtn"></li>
                        <?php endif; ?>
                    </ul>
