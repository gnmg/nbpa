        ...
        <div class="inner-container"><a href="/<?php echo $locale ?>/" class="header__logo">
          ...
          <nav>
            <ul>
              ...
              <li><a href="/<?php echo $locale ?>/contest-details.html">比赛详情</a></li>
              <li><a href="/user/entry/entry?lang=<?php echo $locale ?>">参赛入口</a></li>
              <li><a href="/<?php echo $locale ?>/judges.html">JUDGES</a></li>
              <li><a href="/<?php echo $locale ?>/exhibitions.html">展览会</a></li>
              <li><a href="/<?php echo $locale ?>/gallery/" class="last">获胜者作品展</a></li>
            </ul>
          </nav>
        </div>
      </header>