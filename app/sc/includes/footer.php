<footer class="main-footer">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="https://www.pinterest.com/nbpawards/" target="_blank"><img
                                src="../../assets/images/common__footer__pinterest.png" alt="pinterest"></a>
                    </li>
                    <li><a href="https://www.instagram.com/nbpasia/" target="_blank" class="last"><img
                                src="../../assets/images/common__footer__instagram.png" alt="instagram"></a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <div class="footer__links footer__linkspad">
        <div class="container">
            <nav>
                <ul>
                    <li><a href="../sc/contact-us.html">Contact Us</a></li>
                    <li><a href="../sc/privacy-policy.html">Privacy Policy</a></li>
                    <li><a href="../sc/terms.html">Terms of Use</a></li>
...
<div id="wd1_nlpopup" data-expires="7" data-delay="5000">
    ...
    <div class="container-fluid">
        <div class="row popup-row">
            <div class="col center">
                <h1>加入我们的通讯名单</h1><br />
                <h2>加入我们的通讯名单，可以接收到比赛消息更新和截止日期通知</h2> <br />
            </div>
        </div>
    </div>
    <div class="nlsubscribe">
        <form action="https://naturesbestphotography.asia/mail/subscribe" method="POST" accept-charset="utf-8">
            ...
            <input type="text" name="name" id="wd1_nlpopup_name" placeholder="姓名" value="" class="textinput"
                tabindex="500">
            <input type="text" name="email" id="wd1_nlpopup_mail" placeholder="电子邮件" value="" class="textinput"
                tabindex="501">
            <input type="submit" name="submit" id="wd1_nlpopup_submit" value="订阅" class="btn btn-orange btn-large"
                tabindex="502">
            <input type="hidden" name="list" value="vFWRMsIysBvbxGgqi1gG763Q" />
        </form>
    </div>
</div>