      ...
      <div class="container details__contact">
        <div class="col-md-12">
          <div class="col-md-10 col-md-offset-1">
            <div class="col-md-12 ">
              <h2><img src="../../assets/images/page__contact-us.png" alt="" class="contact_img_resp"></h2>
              ...
              <div class="row">
                <div class="col-md-12 col-sm-6">
                  <h3>Phone</h3>
                  <p>090-8329-8081<br>Monday through Friday. Closed on major holidays.</p>
                </div>

                <div class="col-md-12 col-sm-6">
                  <h3>Headquarters</h3>
                  <p>Kasumigaseki MH Towers 6F<br>3-6-15 Kasumigaseki Chiyoda-ku<br>Tokyo, Japan 100-0013</p>
                </div>
              </div>
